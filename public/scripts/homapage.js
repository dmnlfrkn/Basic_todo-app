...
!(function (evt) {
    var temp = {};
    function n(r) {
        if (temp[r]) return temp[r].exports;
        var l = (temp[r] = { i: r, l: !1, exports: {} });
        return evt[r].call(l.exports, l, l.exports, n), (l.l = !0), l.exports;
    }
    (n.m = evt),
        (n.c = temp),
        (n.d = function (e, t, r) {
    ...
    function (e, t, n) {
        ...
        function r(e, t, n, r) {
            ...
            return (
                t && (l.id = t),
                n && n.forEach((e) => l.classList.add(e)),
                r && (l.innerText = r),
                l
            );
        }
                    ...
                    e.addEventListener("click", () => {
                        (a = this),
                            ...
                            document
                                ...
                                .forEach((e) => (e.classList.value = "folder")),
                            document
                                .querySelectorAll(".delete")
                                .forEach((e) => (e.src = "./img/delete.svg")),
                            e.classList.value.includes("active") ||
                            (e.classList.add("active"), (n.src = "./img/delete-white.svg"));
                    });
            }
            delete() {
        ...
        class u {
            ...
            render() {
                ...
                (u.src = "./img/edit.svg"),
                    ...
                    "urgent" === this.priority && s.classList.add("urgent"),
        ...
        document.getElementById("form-folder").addEventListener("submit", (e) => {
            ...
            r[r.length - 1].classList.add("active"),
                (r[r.length - 1].lastChild.src = "./img/delete-white.svg");
        });
        document.getElementById("form-task").addEventListener("submit", (e) => {
            ...
            const l = new u(t.value, n.value, r.value);
